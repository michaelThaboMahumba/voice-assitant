...
// start jarvis with btn
 document.getElementById("start_jarvis_btn").addEventListener("click", () => {
  recognition.start();
})
document.getElementById("stop_jarvis_btn").addEventListener("click", () => {
  stopingR = true;
  recognition.stop();
});
...
// commands
  ...
  if(localStorage.getItem("lang") === "en-US"){
    ...
    if(transcript.includes("switch to Setswana")){
    ...
    if (transcript.includes("What is your name")) {
      readOut("My name is Pixel l am Michael Personal assitant");
      stopingR = true;
      recognition.stop();
    }
 ...
 //if (localStorage.getItem("lang") === "hi-IN"){
   // if(transcript.includes("")){
    ...
    //if(transcript.includes("")){
      //readOutHindi("")
      //speech_lang = "en-US"
      //localStorage.setItem("lang", "en-US")//get lang
      //stopingR = true
      //recognition.stop()
    //  location.reload()
  //    readOut("ready to go sir")
